...
public class AfterLoginEclipse {
     ...
     * @throws SQLException
     */
    private void setTable(int option) throws SQLException {
        ...
        switch (option) {
            case 1:
                ...
                break;
            case 2:
                games = this.service.sortByNrPlaces();
                sortTable(games);
                break;
            default:
                games = this.service.getAllGames();
...
//        this.model = new DefaultTableModel();
     ...
     * @param games
     */
    public void newTable(List<Game> games) throws SQLException {
        this.model.setColumnIdentifiers(AfterLoginEclipse.columnHeaders);
        // add relevant information to a game
        games.forEach(game -> {
            this.model.addRow(new Object[]{game.getId(), game.getTeam1(), game.getTeam2(), game.getTitle(), game.getPriceOfTicket(), game.getTickets()});
        ...
        this.model.fireTableDataChanged();
        if (this.jtable != null) {
            AfterLoginEclipse afterLoginEclipse = new AfterLoginEclipse();
        ...
        this.btnBuyTickets.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    if (numberFormatException == false && !service.buyTicketsCondition(clinetNameTextField.getText(), Integer.parseInt(idGameTextField.getText()),
                            Integer.parseInt(numberOfTicketsTtextField.getText()))) {
                        ...
                        service.buyTickets(clinetNameTextField.getText(), Integer.parseInt(idGameTextField.getText()),
                                Integer.parseInt(numberOfTicketsTtextField.getText()));
